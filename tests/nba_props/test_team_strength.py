"""Tests for the ridge-regression team-strength model."""

import math

import pytest

from nba_props.models.team_strength import BasketballValueModel


class TestBasketballValueModel:
    def test_fit_and_predict_learns_basketball_signal(self):
    ...
    def test_weighted_fit_respects_high_leverage_games(self):
    ...
    def test_tune_ridge_alpha_runs_cross_validation_and_fits(self):
    ...
    def test_fit_validation(self, features, targets, error):
        with pytest.raises(ValueError, match=error):
            BasketballValueModel().fit(features, targets)

    def test_validation_for_non_finite_values_and_weights(self):
    ...
    def test_feature_name_validation_and_importance(self):
    ...
    def test_rmse_metric(self):
        model = BasketballValueModel(ridge_alpha=1e-6).fit([[1, 2], [2, 3], [3, 4]], [3, 5, 7])
